...
The pipeline code in this repository is released under the [MIT License](LICENSE). The underlying download counts originate from Anaconda's anaconda-package-data.
